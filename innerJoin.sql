...
ALTER TABLE motos
ADD CONSTRAINT motos_ibfk_1 FOREIGN KEY (ID_CLIENTES) REFERENCES clientes(ID_CLIENTES) ON DELETE CASCADE;

-- DETALLES_ORDEN_SERVICIO
ALTER TABLE detalles_orden_servicio
DROP FOREIGN KEY dos_ibfk_1,
DROP FOREIGN KEY dos_ibfk_2,
DROP FOREIGN KEY dos_ibfk_3;

ALTER TABLE detalles_orden_servicio
ADD CONSTRAINT dos_ibfk_1 FOREIGN KEY (ID_ORDEN_SERVICIO) REFERENCES orden_servicio(ID_ORDEN_SERVICIO) ON DELETE CASCADE,
ADD CONSTRAINT dos_ibfk_2 FOREIGN KEY (ID_SERVICIOS) REFERENCES servicios(ID_SERVICIOS) ON DELETE CASCADE,
ADD CONSTRAINT dos_ibfk_3 FOREIGN KEY (ID_PRODUCTOS) REFERENCES productos(ID_PRODUCTOS) ON DELETE CASCADE;

-- INFORME
ALTER TABLE informe
DROP FOREIGN KEY inf_ibfk_1,
DROP FOREIGN KEY inf_ibfk_2,
DROP FOREIGN KEY inf_ibfk_3;

ALTER TABLE informe
ADD CONSTRAINT inf_ibfk_1 FOREIGN KEY (ID_DETALLES_ORDEN_SERVICIO) REFERENCES detalles_orden_servicio(ID_DETALLES_ORDEN_SERVICIO) ON DELETE CASCADE,
ADD CONSTRAINT inf_ibfk_2 FOREIGN KEY (ID_ADMINISTRADOR) REFERENCES administradores(ID_ADMINISTRADOR) ON DELETE CASCADE,
ADD CONSTRAINT inf_ibfk_3 FOREIGN KEY (ID_TECNICOS) REFERENCES tecnicos(ID_TECNICOS) ON DELETE CASCADE;
-- COMPROBANTE
ALTER TABLE comprobante
DROP FOREIGN KEY comp_ibfk_1,
DROP FOREIGN KEY comp_ibfk_2,
DROP FOREIGN KEY comp_ibfk_3;

ALTER TABLE comprobante
ADD CONSTRAINT comp_ibfk_1 FOREIGN KEY (ID_INFORME) REFERENCES informe(ID_INFORME) ON DELETE CASCADE,
ADD CONSTRAINT comp_ibfk_2 FOREIGN KEY (ID_CLIENTES) REFERENCES clientes(ID_CLIENTES) ON DELETE CASCADE,
ADD CONSTRAINT comp_ibfk_3 FOREIGN KEY (ID_ADMINISTRADOR) REFERENCES administradores(ID_ADMINISTRADOR) ON DELETE CASCADE;

-- HISTORIAL
ALTER TABLE historial
DROP FOREIGN KEY hist_ibfk_1,
DROP FOREIGN KEY hist_ibfk_2,
DROP FOREIGN KEY hist_ibfk_3,
DROP FOREIGN KEY hist_ibfk_4,
DROP FOREIGN KEY hist_ibfk_5;

ALTER TABLE historial
ADD CONSTRAINT hist_ibfk_1 FOREIGN KEY (ID_ORDEN_SERVICIO) REFERENCES orden_servicio(ID_ORDEN_SERVICIO) ON DELETE CASCADE,
ADD CONSTRAINT hist_ibfk_2 FOREIGN KEY (ID_COMPROBANTE) REFERENCES comprobante(ID_COMPROBANTE) ON DELETE CASCADE,
ADD CONSTRAINT hist_ibfk_3 FOREIGN KEY (ID_INFORME) REFERENCES informe(ID_INFORME) ON DELETE CASCADE,
ADD CONSTRAINT hist_ibfk_4 FOREIGN KEY (ID_TECNICOS) REFERENCES tecnicos(ID_TECNICOS) ON DELETE CASCADE,
ADD CONSTRAINT hist_ibfk_5 FOREIGN KEY (ID_CLIENTES) REFERENCES clientes(ID_CLIENTES) ON DELETE CASCADE;
